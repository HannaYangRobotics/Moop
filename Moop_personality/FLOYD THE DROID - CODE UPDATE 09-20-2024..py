...
# Board.RGB.setPixelColor(0, Board.PixelColor(0, 255, 0)) # Green LED (LED CONTROL DISABLED)
...
def flash_LED(): # Displays Blue LED heartbeat in its own thread (LED CONTROL DISABLED)
    while True:
        # Board.RGB.setPixelColor(1, Board.PixelColor(0, 0, 50))  # LED CONTROL DISABLED
        # Board.RGB.show()  # LED CONTROL DISABLED
        time.sleep(0.9)
        # Board.RGB.setPixelColor(1, Board.PixelColor(0, 0, 0))  # LED CONTROL DISABLED
        # Board.RGB.show()  # LED CONTROL DISABLED
        time.sleep(0.9)
...
def eyes_red():
    print("  Eyes red (LED CONTROL DISABLED)")
    # eyes.setPixelColor(0, Board.PixelColor(80, 0, 0))  # LED CONTROL DISABLED
    # eyes.setPixelColor(1, Board.PixelColor(80, 0, 0))  # LED CONTROL DISABLED
    
def eyes_orange():
    print("  Eyes orange (LED CONTROL DISABLED)")
    # eyes.setPixelColor(0, Board.PixelColor(80, 10, 0))  # LED CONTROL DISABLED
    # eyes.setPixelColor(1, Board.PixelColor(80, 10, 0))  # LED CONTROL DISABLED
    
def eyes_yellow():
    print("  Eyes yellow (LED CONTROL DISABLED)")
    # eyes.setPixelColor(0, Board.PixelColor(80, 35, 0))  # LED CONTROL DISABLED
    # eyes.setPixelColor(1, Board.PixelColor(80, 35, 0))  # LED CONTROL DISABLED
    
def eyes_green():
    print("  Eyes green (LED CONTROL DISABLED)")
    # eyes.setPixelColor(0, Board.PixelColor(0, 80, 0))  # LED CONTROL DISABLED
    # eyes.setPixelColor(1, Board.PixelColor(0, 80, 0))  # LED CONTROL DISABLED
    
def eyes_blue():
    print("  Eyes blue (LED CONTROL DISABLED)")
    # eyes.setPixelColor(0, Board.PixelColor(0, 0, 80))  # LED CONTROL DISABLED
    # eyes.setPixelColor(1, Board.PixelColor(0, 0, 80))  # LED CONTROL DISABLED
    
def eyes_purple():
    print("  Eyes purple (LED CONTROL DISABLED)")
    # eyes.setPixelColor(0, Board.PixelColor(40, 0, 80))  # LED CONTROL DISABLED
    # eyes.setPixelColor(1, Board.PixelColor(40, 0, 80))  # LED CONTROL DISABLED
...
def exit_program():
    ...
    # Board.RGB.setPixelColor(1, Board.PixelColor(0, 0, 0))  # LED CONTROL DISABLED
    # Board.RGB.show()  # LED CONTROL DISABLED
    # eyes.setPixelColor(0, Board.PixelColor(0, 0, 0))  # LED CONTROL DISABLED
    # eyes.setPixelColor(1, Board.PixelColor(0, 0, 0))  # LED CONTROL DISABLED
...
def flair_1():
    print("  Trigger Flair One - Onboard Beep (LED CONTROL DISABLED)")
    # Board.RGB.setPixelColor(0, Board.PixelColor(0, 255, 0)) # Green LED (LED CONTROL DISABLED)
    # Board.RGB.show()  # LED CONTROL DISABLED
    Board.setBuzzer(100)
    time.sleep(0.5)
...
def flair_2():
    print("  Trigger Flair Two - Onboard Buzz (LED CONTROL DISABLED)")
    # Board.RGB.setPixelColor(0, Board.PixelColor(255, 0, 0)) # Red LED (LED CONTROL DISABLED)
    # Board.RGB.show()  # LED CONTROL DISABLED
    for i in range(13):
        Board.setBuzzer(1)
        time.sleep(0.001)
...
def flair_3():
    print("  Trigger Flair Three - Onboard Chirp (LED CONTROL DISABLED)")
    # Board.RGB.setPixelColor(0, Board.PixelColor(120, 120, 0)) # Yellow LED (LED CONTROL DISABLED)
    # Board.RGB.show()  # LED CONTROL DISABLED
    for i in range(13):
        Board.setBuzzer(1)
        time.sleep(0.015)
...
def flair_4():
    print("  Trigger Flair Four - Rotate arm to the right (SERVO CONTROL DISABLED)")
    # Board.setPWMServoPulse(6, 900, 300)  # SERVO CONTROL DISABLED
    # time.sleep(1.0)  # SERVO CONTROL DISABLED
    
def flair_5():
    print("  Trigger Flair Five - Rotate arm to center position (SERVO CONTROL DISABLED)")
    # Board.setPWMServoPulse(6, 1500, 300)  # SERVO CONTROL DISABLED
    # time.sleep(1.0)  # SERVO CONTROL DISABLED
    
def flair_6():
    print("  Trigger Flair Six - Rotate arm to the left (SERVO CONTROL DISABLED)")
    # Board.setPWMServoPulse(6, 2100, 300)  # SERVO CONTROL DISABLED
    # time.sleep(1.0)  # SERVO CONTROL DISABLED


def flair_7():
    print("  Trigger Flair Seven - Lower arm (SERVO CONTROL DISABLED)")
    # Board.setPWMServoPulse(5, 950, 300)  # SERVO CONTROL DISABLED
    # time.sleep(1.0)  # SERVO CONTROL DISABLED


def flair_8():
    print("  Trigger Flair Eight - Raise arm (SERVO CONTROL DISABLED)")
    # Board.setPWMServoPulse(5, 800, 300)  # SERVO CONTROL DISABLED
    # time.sleep(1.0)  # SERVO CONTROL DISABLED


def flair_9():
    print("  Trigger Flair Nine - Lower wrist (SERVO CONTROL DISABLED)")
    # Board.setPWMServoPulse(3, 400, 300)  # SERVO CONTROL DISABLED
    
def flair_10():
    print("  Trigger Flair Ten - Center wrist (SERVO CONTROL DISABLED)")
    # Board.setPWMServoPulse(3, 700, 300)  # SERVO CONTROL DISABLED
...
def flair_13():
    print("  Trigger Flair Thirteen - Communication FX (LED CONTROL DISABLED)") # Playback volume varies from 0 to 32768
    # Board.RGB.setPixelColor(0, Board.PixelColor(120, 120, 0)) # Yellow LED (LED CONTROL DISABLED)
    # Board.RGB.show()  # LED CONTROL DISABLED
...
def flair_14():
    print("  Trigger Flair Fourteen - Electro FX (LED CONTROL DISABLED)")
    # Board.RGB.setPixelColor(0, Board.PixelColor(255, 0, 0)) # Red LED (LED CONTROL DISABLED)
    # Board.RGB.show()  # LED CONTROL DISABLED
...
def flair_15():
    print("  Trigger Flair Fifteen - Low Boing FX (LED CONTROL DISABLED)")
    # Board.RGB.setPixelColor(0, Board.PixelColor(120, 255, 0)) # Orange LED ? (LED CONTROL DISABLED)
    # Board.RGB.show()  # LED CONTROL DISABLED
...
def flair_16():
    print("  Trigger Flair Sixteen - R2 Chirp FX (LED CONTROL DISABLED)")
    # Board.RGB.setPixelColor(0, Board.PixelColor(0, 255, 0)) # Green LED (LED CONTROL DISABLED)
    # Board.RGB.show()  # LED CONTROL DISABLED
...
def flair_17():
    print("  Trigger Flair Seventeen - R2 Longer Squawk FX (LED CONTROL DISABLED)")
    # Board.RGB.setPixelColor(0, Board.PixelColor(120, 120, 0)) # Yellow LED (LED CONTROL DISABLED)
    # Board.RGB.show()  # LED CONTROL DISABLED
...
def flair_18():
    print("  Trigger Flair Eighteen - R2 Song FX (LED CONTROL DISABLED)")
    # Board.RGB.setPixelColor(0, Board.PixelColor(0, 255, 0)) # Green LED (LED CONTROL DISABLED)
    # Board.RGB.show()  # LED CONTROL DISABLED
...
def flair_19():
    print("  Trigger Flair Nineteen - R2 Splat FX (LED CONTROL DISABLED)")
    # Board.RGB.setPixelColor(0, Board.PixelColor(255, 0, 0)) # Red LED (LED CONTROL DISABLED)
    # Board.RGB.show()  # LED CONTROL DISABLED
...
def flair_20():
    print("  Trigger Flair Twenty - Static FX (LED CONTROL DISABLED)")
    # Board.RGB.setPixelColor(0, Board.PixelColor(255, 0, 0)) # Red LED (LED CONTROL DISABLED)
    # Board.RGB.show()  # LED CONTROL DISABLED
...
voice_commands = {
    ...
    # "arm left": arm_left,  # SERVO CONTROL DISABLED
    # "arm center": arm_center,  # SERVO CONTROL DISABLED
    # "arm right": arm_right,  # SERVO CONTROL DISABLED
    # "open": open_gripper,  # SERVO CONTROL DISABLED
    # "drop": open_gripper,  # SERVO CONTROL DISABLED
    # "close": close_gripper,  # SERVO CONTROL DISABLED
    # "pickup": pick_up,  # SERVO CONTROL DISABLED
    # "pick up": pick_up,  # SERVO CONTROL DISABLED
    ...
    # "eyes red": eyes_red,  # LED CONTROL DISABLED
    # "eyes orange": eyes_orange,  # LED CONTROL DISABLED
    # "eyes yellow": eyes_yellow,  # LED CONTROL DISABLED
    # "eyes green": eyes_green,  # LED CONTROL DISABLED
    # "eyes blue": eyes_blue,  # LED CONTROL DISABLED
    # "eyes purple": eyes_purple,  # LED CONTROL DISABLED
    
    # "anger": eyes_red,  # LED CONTROL DISABLED
    # "anxiety": eyes_orange,  # LED CONTROL DISABLED
    # "happiness": eyes_yellow,  # LED CONTROL DISABLED
